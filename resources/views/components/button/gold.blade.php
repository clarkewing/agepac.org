<a {{ $attributes->class(['relative rounded-lg px-4 py-2 hover:animate-wiggle focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500 active:text-white/70 overflow-hidden']) }}>
    <div
