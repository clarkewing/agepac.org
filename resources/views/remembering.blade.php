            ...
            <main>
                <div class="relative bg-universe">
                    <div class="absolute inset-x-0 bottom-0 lg:top-0 lg:h-full">
                        <div class="h-full w-full lg:grid lg:grid-cols-2">
                            <div class="h-full lg:relative lg:col-start-2">
                                ...
                                />
                                <div aria-hidden="true" class="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-universe lg:inset-y-0 lg:left-0 lg:h-full lg:w-32 xl:w-44 lg:bg-gradient-to-r"></div>
                                <div aria-hidden="true" class="absolute inset-x-0 bottom-0 h-12 bg-gradient-to-t from-universe"></div>
                            </div>
                        </div>
                    </div>
                    <div class="max-w-4xl mx-auto px-4 pt-20 lg:pt-24 sm:px-6 lg:max-w-7xl lg:px-8 lg:grid lg:grid-cols-2 lg:grid-flow-col-dense lg:gap-x-8">
                        <div class="relative pt-12 pb-64 md:pb-[30rem] lg:col-start-1 lg:pb-24">
                            <h1 class="mt-4 text-4xl tracking-tight font-extrabold text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                                En hommage à nos EPL disparus
                            </h1>

                            <blockquote class="mt-6 sm:mt-8 md:flex-grow md:flex md:flex-col">
                                <div class="relative font-medium text-base text-gray-300 sm:mt-5 sm:text-xl lg:text-lg xl:text-xl md:flex-grow">
